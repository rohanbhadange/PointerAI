...
public sealed class WorkerSetupWindow : Window
{
    ...
    private UIElement BuildContent()
    {
        ...
        panel.Children.Add(new TextBlock
        {
            Text = "Choose whether ClickyClone should use your own Cloudflare Worker or local keys stored on this computer.",
        ...
        panel.Children.Add(BodyText("Deploy the Worker from a terminal, add secrets in Cloudflare, then paste the Worker URL here. ClickyClone will verify the Worker before saving it."));
