  ...
  async fetch(request, env) {
    ...
    try {
      if (url.pathname === "/health") {
        return jsonResponse({ ok: true, service: "nudge-worker" });
      }
...
const SYSTEM_PROMPT = `
you are nudge, a friendly always-on windows desktop companion. the user speaks to you with push-to-talk, and you can see screenshots of their monitors.
